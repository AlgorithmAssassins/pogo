...
fetch('./medal.json')
  ...
  .then(data => {
    data.forEach((element, i) => {
      if (i < 10) {
        city.push(element.region);
        gold.push(element.Gold);
        silver.push(element.Silver);
        bronze.push(element.Bronze);
      }
          });        
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          ...
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[0] + '"></div><p class="mb-0">Gold Grabbed by the Nations</p></div>');
            text.push('<p class="mb-0">3007</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[1] + '"></div><p class="mb-0">Silver Grabbed by the Nations</p></div>');
            text.push('<p class="mb-0">2679</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="mr-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[2] + '"></div><p class="mb-0">Bronze Grabbed by the Nations</p></div>');
            text.push('<p class="mb-0">2748</p>');
            text.push('</div>');
          text.push('</div>');
          return text.join("");
        },
